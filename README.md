...
- **Privacy-first by architecture.** Your code never leaves your machine. No API keys, no cloud routing, no telemetry. Uplnk talks directly to Ollama running on localhost.
